...
Categoria VARCHAR(128) NOT NULL UNIQUE CHECK (Categoria REGEXP '^[a-zA-ZÀ-ÖØ-öø-ÿ]+$'),
Criado_em DATETIME DEFAULT CURRENT_TIMESTAMP,
Modificado_em DATETIME,
Status BOOLEAN DEFAULT true);

CREATE TABLE tbsubcategoria(
Subcategoria VARCHAR(128) NOT NULL UNIQUE CHECK (Subcategoria REGEXP '^[a-zA-ZÀ-ÖØ-öø-ÿ]+$'),
Criado_em DATETIME DEFAULT CURRENT_TIMESTAMP,
Modificado_em DATETIME,
...
#USEI A RESTRIÇÃO CHECK PARA QUE SEJA USADO APENAS O ALFABETO, USEI A EXPRESSÃO REGULAR#
