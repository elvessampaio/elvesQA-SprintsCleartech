...
public class ProdutoDAO : IProdutoDAO
{
    ...
    public List<ReadProdutoDto> GetListaProdutos(FiltroProdutoDto filtro)
    {
        ...
        if (filtro.CategoriaId != null)
        {
            ...
            querie += $"PRODUTOS.ID, PRODUTOS.NOME, PRODUTOS.ALTURA, PRODUTOS.CENTRODEDISTRIBUICAO, PRODUTOS.COMPRIMENTO,PRODUTOS.DESCRICAO, PRODUTOS.DATAEHORACRIACAO, PRODUTOS.DATAEHORAMODIFICACAO, PRODUTOS.LARGURA, PRODUTOS.PESO, PRODUTOS.QUANTIDADEEMESTOQUE, PRODUTOS.STATUS, PRODUTOS.SUBCATEGORIAID, PRODUTOS.VALOR FROM `E-COMMERCE(API)`.PRODUTOS INNER JOIN `E-COMMERCE(API)`.SUBCATEGORIAS ON PRODUTOS.SUBCATEGORIAID = SUBCATEGORIAS.ID WHERE ";
